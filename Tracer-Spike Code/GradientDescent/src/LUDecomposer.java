...
public class LUDecomposer 
 {
    ...
    public static Matrix[] decompose(Matrix a) throws Exception
    {
    	if (a == null)
    ...
    public static double[] solve(double[] b, Matrix[] LUP) throws Exception
    {
    ...
    private static double[] forwardSub(double[] b, Matrix L, Matrix P) throws Exception
    {
        int n = b.length;
