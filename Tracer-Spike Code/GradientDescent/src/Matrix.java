...
public class Matrix 
{
    ...
    public double norm()
    {
        if (cols != 1)
        {
            System.out.println("Cannot calc norm for multi-col matrix");
    ...
    public static double determinant(Matrix m) throws Exception
    {
    	if (!m.isSquare())
    		throw new Exception("Cannot calculate determinant of nonsquare matrix");
    ...
    public Matrix padMatrix() throws Exception
    {
    	if(!isSquare())
    		throw new Exception("I'm really not that square.");
   ...
   /* public Matrix getInverse() throws Exception
    {
    	if (!isSquare())
    		throw new Exception("Cannot invert a nonsquare matrix");
    ...
    public double[] toArray() throws Exception
    {
        if (cols != 1)
        {
             throw new Exception("Cannot convert matrix to Array");
        }
	 ...
	 public Vec3 toVec3() throws Exception 
	 {
	     if (cols != 1 || rows < 3)
	     {
			throw new Exception("Cannot convert matrix to vec3");
	 ...
	 public Vec4 toVec4() throws Exception
	 {
	     if (cols != 1 || rows != 4)
	     {
	         throw new Exception("Cannot convert matrix to vec4");
	     }
	     else
	     {
	...
	public Vec3[] toVec3Array() throws Exception
	{
	    if (rows != 3)
	    {
	        throw new Exception("Cannot convert matrix to vec3Array");
	    }
